...
function EditReviewPage() {
    ...
    useEffect(() => {
        const getDetailReview = async () => {
            ...
            if (res != 'undefined' && res != null) {
                ...
                setFile(res.data.response.files[0]);
            }
        }
        getDetailReview();
    }, []);
    ...
    const editPost = async () => {
        ...
        await axios.put(`${process.env.REACT_APP_SERVER}/v1/posts/${postId}`,
            {
                "title": title,
                "content": content,
                "categoryName": "computer"
            ...
            <div className="flex align-center justify-center mt-28">
                <div className="flex justify-center flex-col p-6 w-4/5 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="flex justify-end">
                        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none mt-5 focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={editPost}>
